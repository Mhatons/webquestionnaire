...
import { CheckCircle, Globe, Palette, Settings, PoundSterling, Sparkles } from "lucide-react"
import axios from "axios"
import Loader from "@/features/loader"
import slantedGradient from "../../../public/slanted-gradient.png"
...
export default function ClientQuestionnaire() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const emailPayload = {
        to_email: 'anthonyfaruna1@gmail.com,mhatons@gmail.com',
        ...
        Payment Gateways: ${formData.paymentGateways}
        Booking Type: ${formData.bookingType}
        Calendar Integration: ${formData.calendarIntegration}
        Content Provider: ${formData.contentProvider}
        Need Copywriting: ${formData.needCopywriting}
        Maintenance Preference: ${formData.maintenancePreference}
    ...
    emailjs.send(
        ...
        const autoReplyEmailPayload = {
            ...
            host: "Mhatons Tech Hub",
            host_email: "mhatons@gmail.com",
        };
  ...
  return (
    <div 
      style={{ 
        // backgroundImage: 'url("https://www.transparenttextures.com/patterns/gravel.png")',
      }}
    className="min-h-screen py-8 px-4 relative p-10 overflow-hidden ">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="flex justify-center mb-12">
          <div className="glass-effect rounded-full p-4 bg-zinc-100 shadow-lg">
        ...
        <div className="space-y-8 ">
          ...
          {currentSection === 0 && (
            <div 
            className="gradient-border bg-white rounded-2xl animate-float">
          ...
          {currentSection === 1 && (
            <div className="gradient-border bg-white rounded-2xl animate-float">
              <Card className="border-0 shadow-2xl py-8">
                <CardHeader className="pb-6">
                  <CardTitle className="flex items-center gap-3 text-2xl">
                    <div className="p-2 bg-primary rounded-lg">
        ...
        {isLoading && 
        <div className="fixed bg-white inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          Processing...
        </div>}
      </div>
    </div>
